    ...
    return (
        <main ref={containerRef} className="min-h-screen bg-[#0b1015] text-white overflow-x-hidden pb-32">
            ...
            <section className="min-h-[90dvh] flex flex-col items-center justify-center px-4 relative z-10 gap-8 mt-50">
                ...
                <p className="text-xl md:text-3xl text-gray-300 w-full px-4 sm:px-8 text-center leading-relaxed">
            ...
            <section className="py-12 px-4 w-full md:px-12 flex justify-center text-center overflow-hidden">
                <div id="vision-section" className="flex w-full flex-col justify-center items-center">
                    <div className="w-full">
                        ...
                        <div className="value-desc space-y-6 text-xl leading-relaxed text-gray-300 sm:text-2xl md:text-3xl lg:leading-[1.5] w-full mt-12 mb-32 opacity-0 max-w-7xl mx-auto">
                            <p>
            ...
            <section className="py-12 px-4 w-full md:px-12 flex justify-center text-center overflow-hidden">
                <div id="team-section" className="flex w-full flex-col justify-center items-center">
                    <div className="w-full">
                        ...
                        <div className="value-desc flex flex-col items-center space-y-6 text-xl leading-relaxed text-gray-300 sm:text-2xl md:text-3xl lg:leading-[1.5] w-full mt-12 mb-32 opacity-0 max-w-7xl mx-auto">
